...
class OGBoost(object):
    ...
    def __init__(self, learners, classes, total_points=10, K=1):
        self.M = total_points
        self.K = K
        self.learners = [[learners(classes) for _ in range(self.K)]
