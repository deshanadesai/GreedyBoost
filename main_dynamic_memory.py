...
if __name__ == "__main__":
    ...
    algorithms = {
    "m = ALL":ozaboost_dynamic.OzaBoostClassifier,
    "m = 50":ozaboost_dynamic.OzaBoostClassifier,
    "m = 100":ozaboost_dynamic.OzaBoostClassifier,
    "m = 200":ozaboost_dynamic.OzaBoostClassifier
    }
    ...
    for (name, ensembler) in tqdm(algorithms.iteritems()):
        ...
        for i in range(1,11):
            ...
            for t in range(T):
                ...
                y_cut = y_train[0:num]
                if name!="m = ALL":
                    model = test_dynamic_memory.Test(ensembler, weak_learners[args.weak_learner], X_cut, y_cut, args.M, l)
